...
import { getLastEmail } from '@/lib/auth/pinAuth';
      ...
      >
        ...
        <View style={{ flex: 1, paddingHorizontal: spacing.screenPadding }}>
          <View style={{ paddingTop: 64, paddingBottom: 48 }}>
            <Text style={{ fontSize: 32, fontFamily: 'SUIT-Bold', color: colors.text.primary, marginBottom: 8 }}>
              GLLO
            </Text>
          ...
          <View style={{ flex: 1, justifyContent: 'center' }}>
            <Text style={{ fontSize: 20, fontFamily: 'SUIT-Bold', color: colors.text.primary, marginBottom: 8 }}>
              이메일로 시작하기
            </Text>
